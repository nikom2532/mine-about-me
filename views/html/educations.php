				...
				<dl class="education-associated">
					...
					<dd class="">
						<ul>
							...
							<li>
								<h6>2nd Round Competition of Chulalongkorn University's Science Weekly Day</h6>
								<p>
									<span>2nd Round Competition of Chulalongkorn University's Science Weekly Day
										-- Subject: Computer
							...
							<li class="row-first">
								<h6>ABAC 's Science Weekly Day's Competition</h6>
								<p>
