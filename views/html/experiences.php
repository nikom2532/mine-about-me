		...
		<div id="experience-317866530" class="editable-item section-item tall50">
			<div id="experience-317866530-view">
				...
				<p class="description">
					...
					<br>
					just did for few days or few nights per week.
					<br>
					<br>
					Cleaner
					<br>
			...
			<div id="experience-254251547-view">
				...
				<dl class="education-associated">
					...
					<dd class="closed ">
						<ul>
							<li class="row-first">
								<h6>ITPR Workbench's Web Application</h6>
								<p>
									<span>An web application for keying by auditor</span><a data-li-trk-code="prof-exp-project-more" href="#background-projects">View</a>
								</p>
							</li>
							<li>
								<h6>ITPR Change management (Support)</h6>
								<p>
									<span>Consult and make a user manual the OTRS CMS to customer.</span><a data-li-trk-code="prof-exp-project-more" href="#background-projects">View</a>
								</p>
							</li>
						</ul>
					</dd>
